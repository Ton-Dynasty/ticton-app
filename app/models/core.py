...
class Position(BaseModel):
    ...
    status: Literal["active", "danger", "closed"] = Field("active", description="Status of position(True if active, False if inactive)")
    reward: Optional[float] = Field(None, description="Reward of position, in human readable format. Only available if position is closed")
